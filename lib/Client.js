...
class Client {
  ...
  start (options) {
    ...
    this.options.url = 'amqp://'
    this.options.url = this.options.url + this.options.user + ':' + this.options.pass + '@'
    this.options.url = this.options.url + this.options.host + ':' + this.options.port
